module.exports = {
  ...
  theme: {
    extend: {
      ...
      borderColor: {
        changebutton: "var(--color-border-changebutton)",
      },
    },
    screens: {
      sm: "640px",
    ...
    boxShadow: {
      ...
      none: "none",
      button: "0 2px 4px rgba(0,0,0,.08), 0 4px 12px rgba(0,0,0,.08)",
      focusInput:
        "inset 0 1px 1px rgb(0 0 0 / 8%), 0 0 8px rgb(42 171 166 / 31%)",
    },
    container: {},
    cursor: {
      auto: "auto",
